...
urlpatterns = [
    ...
    path('productosB/<int:producto_id>',views.eliminar_producto,name='eliminar_producto'),
    path('clientes/',views.clientess,name='clientes'),
    path('agregar_clientes/', views.agregar_cliente, name='agregar_clientes'),
    path('clientesB/<int:clientes_id>/', views.borrar_clientes,name='borrar_clientes' ),
    path('editar_clientesB/<int:clientes_id>',views.editar_cliente,name='editar_cliente'),
    path('clientes/', views.lista_clientesss, name='lista_clientesss'),
